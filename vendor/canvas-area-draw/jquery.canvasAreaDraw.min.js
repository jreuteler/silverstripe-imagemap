(function(d){d.fn.canvasAreaDraw=function(d){this.each(function(f,e){v.apply(e,[f,e,d])})};var v=function(t,f,e){var b,g,h,c,n,l,q,u,r,m,p=!1;t=d.extend({imageUrl:d(this).attr("data-image-url")},e);e=d(f).val().replace(/[^0-9\,]/ig,"");b=e.length?e.split(",").map(function(a){return parseInt(a,10)}):[];e=d('<button type="button" class="btn"><i class="icon-trash"></i>Clear</button>');h=d("<canvas>");c=h[0].getContext("2d");n=new Image;r=function(){h.attr("height",
